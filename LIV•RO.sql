...
insert into Livro(ISBN, TITULO, EDITORA, VOLUME, EDICAO, DESCRIÇÃO)
values (978-1-42334-425-4,'Cidades de papel', 'Intrínseca','único','2ª Edição','Busca por Margo'),
	   (978-2-73246-938-6,'Lola e o Garoto da casa ao Lado','Novo Conceito','único','1ª Edição','Vizinho misterioso'),
       (978-9-13216-166-7,'A Probabilidade EstatÍstica do amor à primeira Vista','Galera','único','2ª Edição','O amor é curioso'),
       (978-8-50109-858-0,'A Desconstrução de Mara Dyer','Galera','1','2ª Edição',' Uma nova cidade surge'),
       (978-8-58057-534-7,'Não se apega não','Intrínseca','1','4ª Edição','Deixa a vida levar'),
       (978-2-12345-456-7,'Uma história entre nós','Benvirá','3','3ª Edição','Nós somos alma gêmeas'),
       (978-7-12569-458-7,'Amor & Gelato','Intrínseca','9','1ª Edição','Sorvete combina'),
       (875-6-85472-415-8,'Por lugares incríveis','Seguinte','único','1ª Edição',' Conheça-os'),
       (854-1-68952-845-7,'O Homem de Giz','Intrínseca','único','2ª Edição','Giz era sua matéria'),
       (547-7-75236-748-4,'Fahrenheit 451','Biblioteca Azul','8','5ª Edição','Que temperatura');
...
#where ISBN = 'Escolha do usuário';
#where TITULO = 'Escolha do usuário';
#where EDITORA= 'Escolha do usuário';
#where VOLUME = 'Escolha do usuário';
#where EDICAO = 'Escolha do usuário';
...
#delete from Usuario
#where NOME = 'Escolha do usuário';
#where NICKNAME = 'Escolha do usuário';
#where EMAIL = 'Escolha do usuário';
#where SENHA = 'Escolha do usuário';
#where DATA_NASC = 'Escolha do usuário';
#where ID_USUARIO = 'Escolha do usuário';
...
#Delete from Exemplar 
#where ID = 'Escolha do usuário';
#where Situacao = 'Escolha do usuário';
#where Estado_do_livro = 'Escolha do usuário';
#where ISBN = Escolha do usuário;
...
#where REMETENTE = 'Escolha do usuário';
#where DESTINATARIO = 'Escolha do usuário';
#where DATA_ENVIO = 'Escolha do usuário';
#where ID_MENSAGENS = 'Escolha do usuário';
...
#where ID_Endereco = 'Escolha do usuário';
#where cidade = 'Escolha do usuário';
#where estado = 'Escolha do usuário';
#where zona = 'Escolha do usuário';
#where usuario_id = 'Escolha do usuário';
